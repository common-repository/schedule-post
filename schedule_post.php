...
function sp_activation() {
	sp_add_default_option();
	sp_update_schedule();  //start this cron job
}

function sp_add_default_option() {
...
function sp_add_option_page() {
	add_options_page('Schedule Post Option', 'Schedule Post', 8, basename(__FILE__), 'sp_option_page');
}
...
<div class="wrap">
	...
	<p>Schedule Post plugin automatically publish post at regular intervals. It read text files from specified path and parse it into posts.</p>
	...
	<input type="text" size="40" name="path" value="<?php echo $sp_option['path'];?>"/>(Please set the permission of this folder to 0777)</p>
...
/**
 * This function is fired every hour, if it's time to publish
